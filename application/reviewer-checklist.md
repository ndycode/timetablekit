...
Status: public repository, release, deployment, and npm publication checks complete on 2026-09-01.
...
- [x] Install the [published package](https://www.npmjs.com/package/@ndycode/timetablekit) in a clean directory and parse a synthetic event with JSON, CSV, and ICS exports.

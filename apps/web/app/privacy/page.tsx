    ...
    <main id="main-content" className="page-shell">
      ...
      <article className="doc-content">
        ...
        <section>
          ...
          <p>
            The public playground has no recovery provider configured. When you
            enable its recovery control and an input needs recovery, it reports
            that recovery is unavailable and makes no remote request. In another
            host, a provider must be configured and the host must set{" "}
